  ...
  return (
    <Layout>
            ...
            <div>
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-4">
                  <MapPin size={24} className="text-buildease-yellow mt-1" />
                  <div>
                    <h3 className="font-medium text-lg">Address</h3>
                    <p className="text-gray-600">123 Construction Ave, Building City, BC 10001</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  <Phone size={24} className="text-buildease-yellow mt-1" />
                  <div>
                ...
                <div className="flex items-start space-x-4">
                  <Mail size={24} className="text-buildease-yellow mt-1" />
                  <div>
                    <h3 className="font-medium text-lg">Email</h3>
                    <p className="text-gray-600">info@buildease.com</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  <Clock size={24} className="text-buildease-yellow mt-1" />
                  <div>
      ...
      <section className="pb-16">
        <div className="container mx-auto px-6">
          <div className="aspect-[16/9] w-full bg-gray-200 rounded-xl">
